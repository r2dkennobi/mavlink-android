...
*/
public class msg_mission_request extends com.mavlink.MAVLink.Messages.MAVLinkMessage {
    ...
    *
    */
    public msg_mission_request(com.mavlink.MAVLinkPacket mavLinkPacket){
