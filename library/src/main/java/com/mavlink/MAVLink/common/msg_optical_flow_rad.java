...
*/
public class msg_optical_flow_rad extends com.mavlink.MAVLink.Messages.MAVLinkMessage {
    ...
    *
    */
    public msg_optical_flow_rad(com.mavlink.MAVLinkPacket mavLinkPacket){
