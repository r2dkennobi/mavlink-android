...
*/
public class msg_set_actuator_control_target extends com.mavlink.MAVLink.Messages.MAVLinkMessage {
    ...
    */
    public com.mavlink.MAVLinkPacket pack(){
        ...
        for (float control : controls) {
            packet.payload.putFloat(control);
        }
    ...
    *
    */
    public msg_set_actuator_control_target(com.mavlink.MAVLinkPacket mavLinkPacket){
