...
*/
public class msg_attitude_quaternion_cov extends com.mavlink.MAVLink.Messages.MAVLinkMessage {
    ...
    */
    public com.mavlink.MAVLinkPacket pack(){
        ...
        for (float aCovariance : covariance) {
            packet.payload.putFloat(aCovariance);
        }
    ...
    *
    */
    public msg_attitude_quaternion_cov(com.mavlink.MAVLinkPacket mavLinkPacket){
