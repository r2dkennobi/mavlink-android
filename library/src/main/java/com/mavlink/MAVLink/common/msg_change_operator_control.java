...
*/
public class msg_change_operator_control extends com.mavlink.MAVLink.Messages.MAVLinkMessage {
    ...
    */
    public com.mavlink.MAVLinkPacket pack(){
        ...
        for (byte aPasskey : passkey) {
            packet.payload.putByte(aPasskey);
        }
    ...
    *
    */
    public msg_change_operator_control(com.mavlink.MAVLinkPacket mavLinkPacket){
