...
* 
*/
public class msg_data_transmission_handshake extends com.mavlink.MAVLink.Messages.MAVLinkMessage {
    ...
    *
    */
    public msg_data_transmission_handshake(com.mavlink.MAVLinkPacket mavLinkPacket){
