...
* 
*/
public class msg_vision_position_estimate extends com.mavlink.MAVLink.Messages.MAVLinkMessage {
    ...
    *
    */
    public msg_vision_position_estimate(com.mavlink.MAVLinkPacket mavLinkPacket){
