...
*/
public class msg_mission_request_int extends com.mavlink.MAVLink.Messages.MAVLinkMessage {
    ...
    *
    */
    public msg_mission_request_int(com.mavlink.MAVLinkPacket mavLinkPacket){
