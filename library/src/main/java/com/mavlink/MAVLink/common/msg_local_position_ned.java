...
*/
public class msg_local_position_ned extends com.mavlink.MAVLink.Messages.MAVLinkMessage {
    ...
    *
    */
    public msg_local_position_ned(com.mavlink.MAVLinkPacket mavLinkPacket){
