...
* 
*/
public class msg_vicon_position_estimate extends com.mavlink.MAVLink.Messages.MAVLinkMessage {
    ...
    *
    */
    public msg_vicon_position_estimate(com.mavlink.MAVLinkPacket mavLinkPacket){
