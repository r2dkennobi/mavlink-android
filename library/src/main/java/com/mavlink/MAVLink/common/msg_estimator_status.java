...
*/
public class msg_estimator_status extends com.mavlink.MAVLink.Messages.MAVLinkMessage {
    ...
    *
    */
    public msg_estimator_status(com.mavlink.MAVLinkPacket mavLinkPacket){
