...
*/
public class msg_resource_request extends com.mavlink.MAVLink.Messages.MAVLinkMessage {
    ...
    */
    public com.mavlink.MAVLinkPacket pack(){
        ...
        for (short anUri : uri) {
            packet.payload.putUnsignedByte(anUri);
        }
        ...
        for (short aStorage : storage) {
            packet.payload.putUnsignedByte(aStorage);
        }
    ...
    *
    */
    public msg_resource_request(com.mavlink.MAVLinkPacket mavLinkPacket){
