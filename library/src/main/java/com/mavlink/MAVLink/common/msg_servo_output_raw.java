...
*/
public class msg_servo_output_raw extends com.mavlink.MAVLink.Messages.MAVLinkMessage {
    ...
    *
    */
    public msg_servo_output_raw(com.mavlink.MAVLinkPacket mavLinkPacket){
