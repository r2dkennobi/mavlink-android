...
*/
public class msg_log_request_data extends com.mavlink.MAVLink.Messages.MAVLinkMessage {
    ...
    *
    */
    public msg_log_request_data(com.mavlink.MAVLinkPacket mavLinkPacket){
