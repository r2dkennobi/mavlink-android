...
public class msg_autopilot_version extends MAVLinkMessage{
    ...
    */
    public MAVLinkPacket pack(){
        ...
        for (short aFlight_custom_version : flight_custom_version) {
            packet.payload.putUnsignedByte(aFlight_custom_version);
        }


        for (short aMiddleware_custom_version : middleware_custom_version) {
            packet.payload.putUnsignedByte(aMiddleware_custom_version);
        }


        for (short anOs_custom_version : os_custom_version) {
            packet.payload.putUnsignedByte(anOs_custom_version);
        }
