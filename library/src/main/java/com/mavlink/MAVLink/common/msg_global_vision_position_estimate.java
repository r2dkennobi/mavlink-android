...
* 
*/
public class msg_global_vision_position_estimate extends com.mavlink.MAVLink.Messages.MAVLinkMessage {
    ...
    *
    */
    public msg_global_vision_position_estimate(com.mavlink.MAVLinkPacket mavLinkPacket){
