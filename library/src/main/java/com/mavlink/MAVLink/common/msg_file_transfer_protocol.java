...
*/
public class msg_file_transfer_protocol extends com.mavlink.MAVLink.Messages.MAVLinkMessage {
    ...
    */
    public com.mavlink.MAVLinkPacket pack(){
        ...
        for (short aPayload : payload) {
            packet.payload.putUnsignedByte(aPayload);
        }
    ...
    *
    */
    public msg_file_transfer_protocol(com.mavlink.MAVLinkPacket mavLinkPacket){
