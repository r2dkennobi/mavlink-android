...
*/
public class msg_attitude_quaternion extends com.mavlink.MAVLink.Messages.MAVLinkMessage {
    ...
    *
    */
    public msg_attitude_quaternion(com.mavlink.MAVLinkPacket mavLinkPacket){
