...
*/
public class msg_scaled_pressure extends com.mavlink.MAVLink.Messages.MAVLinkMessage {
    ...
    *
    */
    public msg_scaled_pressure(com.mavlink.MAVLinkPacket mavLinkPacket){
