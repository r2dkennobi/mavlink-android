...
*/
public class msg_mission_request_list extends com.mavlink.MAVLink.Messages.MAVLinkMessage {
    ...
    *
    */
    public msg_mission_request_list(com.mavlink.MAVLinkPacket mavLinkPacket){
