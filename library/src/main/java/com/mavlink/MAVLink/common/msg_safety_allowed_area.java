...
*/
public class msg_safety_allowed_area extends com.mavlink.MAVLink.Messages.MAVLinkMessage {
    ...
    *
    */
    public msg_safety_allowed_area(com.mavlink.MAVLinkPacket mavLinkPacket){
