...
*/
public class msg_named_value_int extends com.mavlink.MAVLink.Messages.MAVLinkMessage {
    ...
    *
    */
    public msg_named_value_int(com.mavlink.MAVLinkPacket mavLinkPacket){
