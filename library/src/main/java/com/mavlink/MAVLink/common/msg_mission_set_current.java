...
*/
public class msg_mission_set_current extends com.mavlink.MAVLink.Messages.MAVLinkMessage {
    ...
    *
    */
    public msg_mission_set_current(com.mavlink.MAVLinkPacket mavLinkPacket){
