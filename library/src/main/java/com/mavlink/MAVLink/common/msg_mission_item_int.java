...
*/
public class msg_mission_item_int extends com.mavlink.MAVLink.Messages.MAVLinkMessage {
    ...
    *
    */
    public msg_mission_item_int(com.mavlink.MAVLinkPacket mavLinkPacket){
