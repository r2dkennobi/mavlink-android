...
*/
public class msg_terrain_data extends com.mavlink.MAVLink.Messages.MAVLinkMessage {
    ...
    *
    */
    public msg_terrain_data(com.mavlink.MAVLinkPacket mavLinkPacket){
