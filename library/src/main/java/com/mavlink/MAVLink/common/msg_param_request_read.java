...
*/
public class msg_param_request_read extends com.mavlink.MAVLink.Messages.MAVLinkMessage {
    ...
    */
    public com.mavlink.MAVLinkPacket pack(){
        ...
        for (byte aParam_id : param_id) {
            packet.payload.putByte(aParam_id);
        }
    ...
    *
    */
    public msg_param_request_read(com.mavlink.MAVLinkPacket mavLinkPacket){
