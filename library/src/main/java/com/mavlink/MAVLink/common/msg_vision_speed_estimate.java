...
* 
*/
public class msg_vision_speed_estimate extends com.mavlink.MAVLink.Messages.MAVLinkMessage {
    ...
    *
    */
    public msg_vision_speed_estimate(com.mavlink.MAVLinkPacket mavLinkPacket){
