...
* 
*/
public class msg_distance_sensor extends com.mavlink.MAVLink.Messages.MAVLinkMessage {
    ...
    *
    */
    public msg_distance_sensor(com.mavlink.MAVLinkPacket mavLinkPacket){
