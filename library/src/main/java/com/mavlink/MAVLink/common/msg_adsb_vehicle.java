...
*/
public class msg_adsb_vehicle extends com.mavlink.MAVLink.Messages.MAVLinkMessage {
    ...
    */
    public com.mavlink.MAVLinkPacket pack(){
        ...
        for (byte aCallsign : callsign) {
            packet.payload.putByte(aCallsign);
        }
    ...
    *
    */
    public msg_adsb_vehicle(com.mavlink.MAVLinkPacket mavLinkPacket){
