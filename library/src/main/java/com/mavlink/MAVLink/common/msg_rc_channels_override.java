...
*/
public class msg_rc_channels_override extends com.mavlink.MAVLink.Messages.MAVLinkMessage {
    ...
    *
    */
    public msg_rc_channels_override(com.mavlink.MAVLinkPacket mavLinkPacket){
