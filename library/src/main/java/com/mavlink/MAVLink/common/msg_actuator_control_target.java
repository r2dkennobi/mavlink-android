...
*/
public class msg_actuator_control_target extends com.mavlink.MAVLink.Messages.MAVLinkMessage {
    ...
    *
    */
    public msg_actuator_control_target(com.mavlink.MAVLinkPacket mavLinkPacket){
