...
*/
public class msg_set_gps_global_origin extends com.mavlink.MAVLink.Messages.MAVLinkMessage {
    ...
    *
    */
    public msg_set_gps_global_origin(com.mavlink.MAVLinkPacket mavLinkPacket){
