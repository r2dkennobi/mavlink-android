...
*/
public class msg_hil_state_quaternion extends com.mavlink.MAVLink.Messages.MAVLinkMessage {
    ...
    */
    public com.mavlink.MAVLinkPacket pack(){
        ...
        for (float anAttitude_quaternion : attitude_quaternion) {
            packet.payload.putFloat(anAttitude_quaternion);
        }
    ...
    *
    */
    public msg_hil_state_quaternion(com.mavlink.MAVLinkPacket mavLinkPacket){
