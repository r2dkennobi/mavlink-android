...
*/
public class msg_gps_inject_data extends com.mavlink.MAVLink.Messages.MAVLinkMessage {
    ...
    *
    */
    public msg_gps_inject_data(com.mavlink.MAVLinkPacket mavLinkPacket){
