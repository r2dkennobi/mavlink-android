...
*/
public class msg_terrain_request extends com.mavlink.MAVLink.Messages.MAVLinkMessage {
    ...
    *
    */
    public msg_terrain_request(com.mavlink.MAVLinkPacket mavLinkPacket){
