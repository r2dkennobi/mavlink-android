...
*/
public class msg_memory_vect extends com.mavlink.MAVLink.Messages.MAVLinkMessage {
    ...
    *
    */
    public msg_memory_vect(com.mavlink.MAVLinkPacket mavLinkPacket){
