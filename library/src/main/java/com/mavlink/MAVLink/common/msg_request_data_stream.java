...
*/
public class msg_request_data_stream extends com.mavlink.MAVLink.Messages.MAVLinkMessage {
    ...
    *
    */
    public msg_request_data_stream(com.mavlink.MAVLinkPacket mavLinkPacket){
