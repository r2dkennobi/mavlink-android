...
*/
public class msg_extended_sys_state extends com.mavlink.MAVLink.Messages.MAVLinkMessage {
    ...
    *
    */
    public msg_extended_sys_state(com.mavlink.MAVLinkPacket mavLinkPacket){
