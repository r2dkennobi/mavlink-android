...
*/
public class msg_global_position_int extends com.mavlink.MAVLink.Messages.MAVLinkMessage {
    ...
    *
    */
    public msg_global_position_int(com.mavlink.MAVLinkPacket mavLinkPacket){
