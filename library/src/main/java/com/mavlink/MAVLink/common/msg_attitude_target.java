...
*/
public class msg_attitude_target extends com.mavlink.MAVLink.Messages.MAVLinkMessage {
    ...
    *
    */
    public msg_attitude_target(com.mavlink.MAVLinkPacket mavLinkPacket){
