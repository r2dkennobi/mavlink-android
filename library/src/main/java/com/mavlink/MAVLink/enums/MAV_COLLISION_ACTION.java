...
package com.mavlink.MAVLink.enums;
...
public class MAV_COLLISION_ACTION {
   ...
   public static final int MAV_COLLISION_ACTION_ASCEND_OR_DESCEND = 2; /* Ascend or Descend to avoid thread | */
   public static final int MAV_COLLISION_ACTION_MOVE_HORIZONTALLY = 3; /* Ascend or Descend to avoid thread | */
