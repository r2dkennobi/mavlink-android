...
package com.mavlink.MAVLink.Messages;

import com.mavlink.MAVLink.common.msg_radio_status;
...
public class MAVLinkStats /* implements Serializable */{
     ...
     */
    public void newPacket(com.mavlink.MAVLinkPacket packet) {
    ...
    private class SystemStat {
        ...
        public int newPacket(com.mavlink.MAVLinkPacket packet) {
    ...
    private class ComponentStat {
        ...
        private int updateLostPacketCount(com.mavlink.MAVLinkPacket packet) {
            int lostPackets;
        ...
        private boolean hasLostPackets(com.mavlink.MAVLinkPacket packet) {
