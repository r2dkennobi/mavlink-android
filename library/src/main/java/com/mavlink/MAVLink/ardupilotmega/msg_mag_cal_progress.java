...
*/
public class msg_mag_cal_progress extends com.mavlink.MAVLink.Messages.MAVLinkMessage {
    ...
    */
    public com.mavlink.MAVLinkPacket pack(){
        ...
        for (short aCompletion_mask : completion_mask) {
            packet.payload.putUnsignedByte(aCompletion_mask);
        }
    ...
    *
    */
    public msg_mag_cal_progress(com.mavlink.MAVLinkPacket mavLinkPacket){
