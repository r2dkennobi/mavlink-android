...
*/
public class msg_gopro_set_request extends com.mavlink.MAVLink.Messages.MAVLinkMessage {
    ...
    *
    */
    public msg_gopro_set_request(com.mavlink.MAVLinkPacket mavLinkPacket){
