...
*/
public class msg_airspeed_autocal extends com.mavlink.MAVLink.Messages.MAVLinkMessage {
    ...
    *
    */
    public msg_airspeed_autocal(com.mavlink.MAVLinkPacket mavLinkPacket){
