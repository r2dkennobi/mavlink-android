...
*/
public class msg_digicam_configure extends com.mavlink.MAVLink.Messages.MAVLinkMessage {
    ...
    *
    */
    public msg_digicam_configure(com.mavlink.MAVLinkPacket mavLinkPacket){
