...
*/
public class msg_set_mag_offsets extends com.mavlink.MAVLink.Messages.MAVLinkMessage {
    ...
    *
    */
    public msg_set_mag_offsets(com.mavlink.MAVLinkPacket mavLinkPacket){
