...
*/
public class msg_gopro_set_response extends com.mavlink.MAVLink.Messages.MAVLinkMessage {
    ...
    *
    */
    public msg_gopro_set_response(com.mavlink.MAVLinkPacket mavLinkPacket){
