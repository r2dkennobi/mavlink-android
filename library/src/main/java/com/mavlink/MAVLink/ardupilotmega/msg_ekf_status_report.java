...
*/
public class msg_ekf_status_report extends com.mavlink.MAVLink.Messages.MAVLinkMessage {
    ...
    *
    */
    public msg_ekf_status_report(com.mavlink.MAVLinkPacket mavLinkPacket){
