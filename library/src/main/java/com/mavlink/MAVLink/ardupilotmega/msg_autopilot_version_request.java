...
*/
public class msg_autopilot_version_request extends com.mavlink.MAVLink.Messages.MAVLinkMessage {
    ...
    *
    */
    public msg_autopilot_version_request(com.mavlink.MAVLinkPacket mavLinkPacket){
