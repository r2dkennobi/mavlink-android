...
*/
public class msg_gopro_get_response extends com.mavlink.MAVLink.Messages.MAVLinkMessage {
    ...
    */
    public com.mavlink.MAVLinkPacket pack(){
        ...
        for (short aValue : value) {
            packet.payload.putUnsignedByte(aValue);
        }
    ...
    *
    */
    public msg_gopro_get_response(com.mavlink.MAVLinkPacket mavLinkPacket){
