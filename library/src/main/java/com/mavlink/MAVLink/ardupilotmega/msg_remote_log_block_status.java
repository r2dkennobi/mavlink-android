...
*/
public class msg_remote_log_block_status extends com.mavlink.MAVLink.Messages.MAVLinkMessage {
    ...
    *
    */
    public msg_remote_log_block_status(com.mavlink.MAVLinkPacket mavLinkPacket){
