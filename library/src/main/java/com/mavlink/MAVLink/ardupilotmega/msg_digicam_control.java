...
*/
public class msg_digicam_control extends com.mavlink.MAVLink.Messages.MAVLinkMessage {
    ...
    *
    */
    public msg_digicam_control(com.mavlink.MAVLinkPacket mavLinkPacket){
