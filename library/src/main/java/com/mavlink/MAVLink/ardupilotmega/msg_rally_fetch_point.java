...
*/
public class msg_rally_fetch_point extends com.mavlink.MAVLink.Messages.MAVLinkMessage {
    ...
    *
    */
    public msg_rally_fetch_point(com.mavlink.MAVLinkPacket mavLinkPacket){
