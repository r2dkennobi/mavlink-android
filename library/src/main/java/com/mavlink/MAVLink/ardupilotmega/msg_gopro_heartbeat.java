...
*/
public class msg_gopro_heartbeat extends com.mavlink.MAVLink.Messages.MAVLinkMessage {
    ...
    *
    */
    public msg_gopro_heartbeat(com.mavlink.MAVLinkPacket mavLinkPacket){
